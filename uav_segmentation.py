...
BASE = r'C:\Users\PC\Coding\ethiopia_uav_segmentation\data\archive\dataset\semantic_drone_dataset'
IMAGE_PATH = os.path.join(BASE, 'original_images')
MASK_PATH = os.path.join(BASE, 'label_images_semantic')
